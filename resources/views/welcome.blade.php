...
<head>
    <title>#DevsDoamVida - Contribua além dos seus commits para a sociedade</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Primary Meta Tags -->
    <meta name="title" content="#DevsDoamVida - Contribua além dos seus commits para a sociedade">
    <meta name="description" content="Campanha de doação entre pessoas desenvolvedoras para a sociedade. Procure o posto de saúde mais próximo e agende sua doação. Esteja atento as regras para doar.">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://doesangue.heartdevs.com/">
    <meta property="og:title" content="#DevsDoamVida - Contribua além dos seus commits para a sociedade">
    <meta property="og:description"
          content="Campanha de doação entre pessoas desenvolvedoras para a sociedade. Procure o posto de saúde mais próximo e agende sua doação. Esteja atento as regras para doar.">
    <meta property="og:image" content="{{ public_path('images/meta.jpg') }}">

    <!-- Twitter -->
    <meta property="twitter:card" content="{{ public_path('images/meta.jpg') }}">
    <meta property="twitter:url" content="https://doesangue.heartdevs.com/">
    <meta property="twitter:title" content="#DevsDoamVida - Contribua além dos seus commits para a sociedade">
    <meta property="twitter:description"
          content="Campanha de doação entre pessoas desenvolvedoras para a sociedade. Procure o posto de saúde mais próximo e agende sua doação. Esteja atento as regras para doar.">
    <meta property="twitter:image" content="{{ public_path('images/meta.jpg') }}">
...
<div>
                    ...
                    <div class="flex flex-wrap items-center">
                        <a href="#">
                            <img class="max-w-[200px] max-h-18"
                                 src="https://cdn.discordapp.com/attachments/606200832517472287/1113685078241980496/image.png"
                                 alt="">
                        </a>
                    </div>
                </div>
                <div class="w-auto">
                    <div class="flex flex-wrap items-center">
                        ...
                        <div class="w-auto lg:hidden">
                            <a href="#">
                                <svg class="text-gray-800 navbar-burger" width="51" height="51" viewbox="0 0 56 56"
                                     fill="none"
                ...
                <nav class="relative z-10 h-full py-8 bg-white px-9">
                    <div class="flex flex-wrap justify-between h-full">
                        ...
                        <div class="flex flex-col justify-center w-full py-8">
                            <ul>
                                <li class="mb-12"><a
                                        class="text-lg font-medium text-gray-900 font-heading hover:text-gray-700"
                                        href="#">Features</a></li>
                                <li class="mb-12"><a
                                        class="text-lg font-medium text-gray-900 font-heading hover:text-gray-700"
                                        href="#">Solutions</a></li>
                                <li class="mb-12"><a
                                        class="text-lg font-medium text-gray-900 font-heading hover:text-gray-700"
                                        href="#">Resources</a></li>
                                <li><a class="text-lg font-medium text-gray-900 font-heading hover:text-gray-700"
                                       href="#">Pricing</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            ...
                                            <div
                                                class="flex items-center justify-center px-2 py-1 bg-purple-100 rounded-full ">
                                                <svg class="mr-1" width="13" height="13" viewbox="0 0 13 13" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#7c3aed" stroke-linecap="round"
                                                        stroke-linejoin="round"></path>
                                                    <path
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            ...
                                            <div
                                                ...
                                                <p class="text-xs font-medium text-purple-600">Juiz de Fora - MG, BR</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            ...
                                            <div
                                                ...
                                                <p class="text-xs font-medium text-purple-600">Uberlândia - MG, BR</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            ...
                                            <div
                                                ...
                                                <p class="text-xs font-medium text-purple-600">Goiânia - GO, BR</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            ...
                                            <div
                                                ...
                                                <p class="text-xs font-medium text-purple-600">Mossoró - RN, BR</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            ...
                                            <div
                                                ...
                                                <p class="text-xs font-medium text-purple-600">Rio de Janeiro - RJ, BR</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            ...
                                            <div
                                                ...
                                                <p class="text-xs font-medium text-purple-600">Maringá - PR, BR</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="relative pt-24 overflow-hidden pb-28">
        <div class="container px-4 mx-auto">
            <div class="max-w-xl mx-auto mb-20">
                ...
                <p class="text-base text-center text-gray-600">Confira o progresso da nossa campanha de doação de sangue
                    e os impactos até o momento. Nosso objetivo é cada vez mais.</p>
            </div>
            <div class="max-w-4xl mx-auto">
                <div
                    class="flex flex-wrap justify-center -m-6 divide-y divide-gray-200 md:-m-16 md:divide-y-0 md:divide-x">
                    <div class="w-full p-6 md:w-1/3 md:p-16">
                        ...
                        <p class="text-center text-gray-600">Pessoas que se comprometeram em fazer a sua parte até o fim
                            da campanha</p>
                    </div>
                    <div class="w-full p-6 md:w-1/3 md:p-16">
                        <h2
                        ...
                        <p class="text-center text-gray-600">Pessoas que vestiram a camiseta da campanha em pró de
                            salvar vidas</p>
                    </div>
                    <div class="w-full p-6 md:w-1/3 md:p-16">
                        <h2
                        ...
                        <p class="text-center text-gray-600">Cada gota importa. De gota em gota, a gente alimenta a
                            vida</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="w-full p-6 lg:w-1/2">
                            <div class="mb-11 lg:max-w-sm">
                                <div class="flex flex-wrap -m-4">
                                    ...
                                    <div class="flex-1 p-4">
                                        <h3 class="mb-4 text-xl font-semibold text-white font-heading">Esteja
                                            atento</h3>
                                        <p class="text-base text-gray-200">Confira como funciona o sistema de doação de
                                            sangue nos postos de coleta da sua cidade e fique atento aos requisitos e
                                            impedimentos. Honestidade também salva vidas. Ao doar sangue, seja sincero
                                            na entrevista.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-11 lg:max-w-sm">
                                <div class="flex flex-wrap -m-4">
                                    ...
                                    <div class="flex-1 p-4">
                                        <h3 class="mb-4 text-xl font-semibold text-white font-heading">Faça a sua
                                            parte</h3>
                                        <p class="text-base text-gray-200">Doe sangue! É seguro, rápido e essencial à
                                            vida. Não se esqueça de tirar uma foto ou um comprovante de doação para
                                            poder participar do movimento.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-11 lg:max-w-sm">
                                <div class="flex flex-wrap -m-4">
                                    ...
                                    <div class="flex-1 p-4">
                                        <h3 class="mb-4 text-xl font-semibold text-white font-heading">Espalhe a
                                            campanha!</h3>
                                        <p class="text-base text-gray-200 mb-11">Faça no nosso site o processo de
                                            confirmação de doação para participar de sorteios e aproveite e poste nas
                                            redes sociais a sua colaboração. Seu compartilhamento ajuda a campanha e a
                                            solidariedade transforma o mundo.</p>
    ...
    <section class="relative pt-24 pb-32 overflow-hidden bg-gray-100">
        <div class="container px-4 mx-auto">
            ...
            <p class="max-w-md mx-auto mb-16 text-base text-center text-gray-600">Obrigado à todos que toparam
                participar dessa iniciativa de honra.</p>
                        ...
                        <div
                            ...
                            <div class="flex flex-col h-full gap-2 p-4 text-center bg-white rounded-xl">
                                <img class="w-full rounded-lg"
                                     src="{{ 'https://cdn.discordapp.com/attachments/219843740439674880/1113855409015509072/user.png' }}"
                                     alt="">
                                    ...
                                    <div class="flex flex-wrap items-center justify-between -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            <svg width="18" height="18" viewbox="0 0 18 18" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.5 3.75L15.75 9M15.75 9L10.5 14.25M15.75 9L2.25 9"
                                                      stroke="#6d28d9"
                                ...
                                <div class="py-3.5 px-5 bg-white">
                                    <div class="flex flex-wrap justify-between -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            <svg width="18" height="18" viewbox="0 0 18 18" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path d="M3.75 7.5L9 2.25M9 2.25L14.25 7.5M9 2.25V15.75"
            ...
            <div class="flex flex-col items-center justify-center flex-1 px-8 py-16 md:px-0">
                <div>
                    <div class="max-w-lg mx-auto text-center mb-14">
                        <h2 class="mb-5 text-6xl font-semibold text-gray-900 font-heading sm:text-7xl">Participe
                            Agora!</h2>
                        <p class="text-lg text-gray-900">Preencha o formulário com informações de onde você doará sangue
                            e deixe
                            seu contato.
                        </p>
                    </div>
