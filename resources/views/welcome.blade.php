...
<div>
    <section class="overflow-hidden"
             style="background: url(https://i.imgur.com/5k7teIx.png) no-repeat; background-size: cover;">
        <section>
                    ...
                    <div class="flex flex-wrap items-center">
                        <div class="w-auto hidden lg:block">
                            <ul class="flex items-center mr-10">
                                <li class="font-heading mr-9 text-white hover:text-gray-200 text-lg"><a href="#">Nossa
                                        Campanha</a>
                                </li>
                                <li class="font-heading mr-9 text-white hover:text-gray-200 text-lg"><a href="#">Como
                                        Doar</a>
                                </li>
                                <li class="font-heading mr-9 text-white hover:text-gray-200 text-lg"><a href="#">Doadores</a>
                                </li>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-between -m-6 pt-32 pb-40">
                <div class="w-full lg:w-5/12 xl:w-1/2 p-6">
                    <p class="mb-5 font-heading text-gray-400 font-medium text-xl">A contribuição com a comunidade pode
                        ir além dos seus commits</p>
                    <h1 class="mb-14 font-heading text-7xl md:text-9xl xl:text-11xl text-white font-bold">
                        Iniciativa #DevsDoamVida
                    </h1>
                    <div class="flex flex-wrap -m-3 mb-20">
                        <div class="w-full lg:w-auto p-3">
                            <button
                                class="font-heading w-full px-6 py-4 text-base text-gray-900 bg-white hover:bg-gray-100 rounded-md">
                                Entenda como contribuir para a iniciativa
                            </button>
                        </div>
                    </div>
                    ...
                    {{--                                    “You made it so simple. My new team is so much--}}
                            ...
                            <div class="w-full p-3">
                                <div
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="w-auto p-2">
                                            <p class="font-heading text-base text-gray-900">Aguardando Doador</p>
                                            ...
                                            <div class="flex items-center px-2 py-1 bg-gray-100 rounded-full">
                                                <svg class="mr-1" width="13" height="13" viewbox="0 0 13 13" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#71717A" stroke-linecap="round"
                                                ...
                                                <p class="text-xs text-gray-700 font-medium">São Paulo, BR</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="relative pt-24 pb-28 overflow-hidden">
        <div class="container mx-auto px-4">
            <div class="max-w-xl mx-auto mb-20">
                <h2 class="mb-5 font-heading font-semibold text-center text-5xl text-gray-900 sm:text-6xl"
            ...
            <div class="max-w-4xl mx-auto">
                <div
                    class="flex flex-wrap justify-center -m-6 md:-m-16 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                    <div class="w-full md:w-1/3 p-6 md:p-16">
                        <h2 class="mb-3 font-heading font-bold text-12xl sm:text-13xl md:text-14xl xl:text-15xl text-center text-transparent bg-clip-text bg-gradient-blue">
                            10</h2>
                    ...
                    <div class="w-full md:w-1/3 p-6 md:p-16">
                        ...
                        <h3 class="mb-3 font-heading font-semibold text-center text-gray-900 text-lg">Doadores
                            concluidos
                        </h3>
                        <p class="text-center text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua
                            dolor</p>
                    ...
                    <div class="w-full md:w-1/3 p-6 md:p-16">
                        <h2 class="mb-3 font-heading font-bold text-12xl sm:text-13xl md:text-14xl xl:text-15xl text-center text-transparent bg-clip-text bg-gradient-green">
                            30L</h2>
    ...
    <section class="relative pt-20 bg-black overflow-hidden">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap -m-6 mb-12">
                <div class="w-full p-6">
                    <h2 class="mb-16 max-w-xl font-heading font-bold text-6xl sm:text-7xl text-white">Three steps to get
                        started</h2>
                        ...
                        <div class="w-full lg:w-1/2 p-6">
                                ...
                                <div class="flex flex-wrap -m-4">
                                    <div class="w-auto p-4">
                                        <div class="p-px max-w-max bg-gradient-cyan2 rounded-full">
                                            <div
                                                class="flex justify-center items-center font-heading text-xl bg-gray-900 w-12 h-12 text-white rounded-full">
                                                1
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex-1 p-4">
                                        <h3 class="mb-4 font-heading font-medium text-xl text-white">Create A Free
                                            Account</h3>
                                        <p class="text-gray-400 text-base">Amet minim mollit non deserunt ullamco est
                            ...
                            <div class="mb-11 lg:max-w-sm">
                                <div class="flex flex-wrap -m-4">
                                    ...
                                    <div class="flex-1 p-4">
                                        <h3 class="mb-4 font-heading font-medium text-xl text-white">Select Your
                                            Package</h3>
                                        <p class="text-gray-400 text-base">Amet minim mollit non deserunt ullamco est
                                            sit aliqua dolor do amet sint. Velit officia consequat duis enim velit
                                            mollit.</p>
                            ...
                            <div class="mb-11 lg:max-w-sm">
                                <div class="flex flex-wrap -m-4">
                                    ...
                                    <div class="flex-1 p-4">
                                        <h3 class="mb-4 font-heading font-medium text-xl text-white">Grow Business
                                            Fast</h3>
                                        <p class="mb-11 text-gray-400 text-base">Amet minim mollit non deserunt ullamco
                                        ...
                                        <div class="group relative max-w-max">
                                            ...
                                            <button
                                                ...
                                                <div
                                                    class="relative p-4 px-11 bg-gradient-green overflow-hidden rounded-md">
                                                    <div
                                                        class="absolute top-0 left-0 transform -translate-y-full group-hover:-translate-y-0 h-full w-full bg-white transition ease-in-out duration-500"></div>
        ...
        <div class="pl-4 lg:absolute lg:bottom-0 lg:right-0 lg:w-1/2">
            <div class="relative max-w-max ml-auto">
                <img class="relative z-10 ml-auto" src="https://i.imgur.com/i7BUfKA.jpeg" alt="">
    ...
    <section class="relative pt-24 pb-32 overflow-hidden">
        <div class="container mx-auto px-4">
            ...
            <p class="mb-16 text-base max-w-md mx-auto text-center text-gray-600">Amet minim mollit non deserunt ullamco
                ...
                @foreach(range(1,5) as $fodase)
                    <div class="w-full md:w-1/5 p-5">
                        <div
                            ...
                            <div class="h-full px-7 py-8 bg-white rounded-lg text-center">
                                <img class="mb-8" src="{{ 'https://github.com/danielhe4rt.png' }}" alt="">
    ...
    <section class="pt-24 pb-36 overflow-hidden">
        <div class="container mx-auto px-4">
            <h2 class="mb-14 font-heading font-semibold text-center text-6xl sm:text-7xl text-gray-900">Frequently asked
                question</h2>
                            ...
                            <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white">
                                    <div class="flex flex-wrap items-center justify-between -m-2">
                                        <div class="w-auto p-2">
                                            <p class="font-heading font-semibold text-lg text-gray-900">Is it really
                                ...
                                <div class="py-3.5 px-5 bg-white">
                                    <div class="flex flex-wrap justify-between -m-2">
                                        <div class="flex-1 p-2">
                                            <p class="mb-5 font-heading font-semibold text-lg text-gray-900">Do you
                        ...
                        <a href="#">
                            <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white">
                                    <div class="flex flex-wrap items-center justify-between -m-2">
                                        <div class="w-auto p-2">
                                            <p class="font-heading font-semibold text-lg text-gray-900">What kind of
                        ...
                        <a href="#">
                            <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white">
                                    <div class="flex flex-wrap items-center justify-between -m-2">
                                        <div class="w-auto p-2">
                                            <p class="font-heading font-semibold text-lg text-gray-900">Can I invite my
                                                team members?</p>
                                        </div>
                                        <div class="w-auto p-2">
                                            <svg width="18" height="18" viewbox="0 0 18 18" fill="none"
                        ...
                        <a href="#">
                            <div>
                                <div class="py-3.5 px-5 bg-white">
                                    <div class="flex flex-wrap items-center justify-between -m-2">
                                        <div class="w-auto p-2">
                                            <p class="font-heading font-semibold text-lg text-gray-900">What is your
                                                refund policy?</p>
                                        </div>
                                        <div class="w-auto p-2">
                                            <svg width="18" height="18" viewbox="0 0 18 18" fill="none"
    ...
    <section class="py-16 bg-black overflow-hidden">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap lg:items-center -m-6">
                ...
                <div class="w-full md:w-1/2 p-6">
                    <ul class="flex flex-wrap -m-5">
                        <li class="p-5"><a class="font-heading text-base text-white hover:text-gray-200" href="#">Features</a>
                        </li>
                        <li class="p-5"><a class="font-heading text-base text-white hover:text-gray-200" href="#">Pricing</a>
                        </li>
                        <li class="p-5"><a class="font-heading text-base text-white hover:text-gray-200" href="#">Affiliate
                                Program</a></li>
                        <li class="p-5"><a class="font-heading text-base text-white hover:text-gray-200" href="#">Press
                                Kit</a></li>
                    </ul>
                </div>
            ...
            <div class="flex flex-wrap items-center justify-between -m-6">
                ...
                <div class="w-auto p-6">
                    <div class="flex flex-wrap -m-6">
                        <div class="w-auto p-6"><a class="text-gray-300 hover:text-gray-400 text-sm" href="#">Privacy
                                Policy</a></div>
                        <div class="w-auto p-6"><a class="text-gray-300 hover:text-gray-400 text-sm" href="#">Terms
                                &amp; Conditions</a></div>
                    </div>
                </div>
            </div>
